...
private:
	...
	// Defines the time span starting from the last STATE_IND until another unsolicited STATE_IND is generated.
	int duration;

	// Shall unsolicited STATE_IND events generated by the owner link only be forwarded in case the new item values
